  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 p-8 md:p-12 xl:p-20">
      <div className="flex flex-col gap-4">
        <h1 className="text-[40px] font-bol">
          How we can help you
        </h1>
        <p className="text-[20px] text-gray-500">
          Follow our newsletter. We will regulary update our latest proyect and availability.
        </p>
        <form className="w-full">
            <div className="relative">     
                ...
                <button 
                type="submit" 
                className="absolute text-lg font-semibold py-2 px-6 bg-primary text-white rounded-xl
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         ...
         <div className="flex flex-col gap-2"> 
           <RiSmartphoneFill 
           className="text-4xl p-2 bg-secondary text-primary box-content rounded-xl"/>
         ...
         <div className=" flex flex-col gap-2">
           < RiMacFill 
           className="text-4xl p-2 bg-secondary text-primary box-content rounded-xl"/>
           <h3 className="text-[20px] font-bold"> Webside Design</h3>
           <p className="text-gray-500">Sometimes features require a short description</p>
         </div>
      </div>
    </div>
